 ...
 *
 * <p>Purdue University -- CS18000 -- Fall 2021 -- Homework 11 -- Walkthrough</p>
 *
 * @author Purdue CS
...
public class UniversityCardGUI {
    ...
    public static int showAgeInputDialog() {
        int age;
        while (true){
            String input = JOptionPane.showInputDialog(null, "What is your age?",
                    "University Card", JOptionPane.QUESTION_MESSAGE);
            try {
    ...
    public static String showClassStandingInputDialog() {
        ...
        String userChoice;
        userChoice = (String) JOptionPane.showInputDialog(null, "Select your class standing",
                "University Card", JOptionPane.QUESTION_MESSAGE,
    ...
    public static void showPrintingDetailsDialog() {
        JOptionPane.showMessageDialog(null, "Printing Details to Terminal...", "University Card",
